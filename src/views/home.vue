...
<template>
    <div>
        <div class="content content-intro" :style="{ display: showAnimae ? 'block' : 'none' }">
            ...
            <!-- <div class="shape-wrap" :style="{ display: showAnimae ? 'block' : 'none' }"><svg class="shape" width="100%"
                    height="100vh" preserveAspectRatio="none" viewBox="0 0 1440 800" style="fill: rgb(30, 31, 33);">
                    <path
            ...
            <div id="card">
                <div class="card-inner fade" :class="{ in: !showAnimae }">
                    ...
                    <ul>
                        ...
                        <li><a @click="topage('learn')" aria-label="Learn"><i class="icon icon-learn"></i><span
                                    data-translate="Learn">Learn</span></a></li>
                        <li><a @click="topage('demo')" aria-label="Demo"><i class="icon icon-demo"></i><span
                                    data-translate="Demo">Demo</span></a></li>
                        <li><a @click="topage('style')" aria-label="Style"><i class="icon icon-ootd"></i><span
